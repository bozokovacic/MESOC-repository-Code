...
<ul class="pager">
    ...
    <li class="pull-right">
        {{ link_to("culturaldomain/new", "Create cultural sector") }}
    </li>
</ul>
...
{% endif %}
    <tbody>
        <tr>
            ...
            <td width="7%">{{ link_to("culturaldomain/edit/" ~ culturaldomain.ID_CultDomain, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td width="7%">{{ link_to("culturaldomain/delete/" ~ culturaldomain.ID_CultDomain, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
