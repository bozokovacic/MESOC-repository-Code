    ...
    <tbody>
        <tr>
            ...
            <td>{{ technique.TechniqueName }}</td>
                <td width="7%">{{ link_to("technique/edit/" ~ technique.ID_Technique, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
                <td width="7%">{{ link_to("technique/delete/" ~ technique.ID_Technique, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
