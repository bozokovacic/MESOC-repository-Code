...
<ul class="pager">
    ...
    <li class="pull-right">
        {{ link_to("keywordtv/new", "Create  keyword transitional variable") }}
    </li>
</ul>
...
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("keywordtv/edit/" ~ keywordtv.ID_Keywordtv, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("keywordtv/delete/" ~ keywordtv.ID_Keywordtv, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
<!--            <td width="7%">{{ link_to("keywordtv/pregledcultdomain/" ~ keywordtv.ID_Keywordtv, '<i class="glyphicon glyphicon-edit"></i> Cultural sector', "class": "btn btn-default") }}</td>
            ...
            <td width="7%">{{ link_to("keyword/linkkeyword/" ~ keyword.ID_Keywordtv, '<i class="glyphicon glyphicon-edit"></i> Link to keyword', "class": "btn btn-default") }}</td>  -->
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
