    ...
    <tbody>
        <tr>
            ...
            <td>{{ searchdatabase.SearchDatabase }}</td>
                <td width="7%">{{ link_to("searchdatabase/edit/" ~ searchdatabase.ID_Database, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td width="7%">{{ link_to("searchdatabase/delete/" ~ searchdatabase.ID_Database, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
...
{% endif %}
{% else %}
    No search database are recorded
{% endfor %}
