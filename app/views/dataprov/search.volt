...
<table class="table table-bordered table-striped" align="center">
    <thead>
        <tr>
            ...
            <th>DATA PROVIDERS NAME CODE</th>
         </tr>
    </thead>
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("dataprov/edit/" ~ dataprov.ID_DataProv, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("dataprov/delete/" ~ dataprov.ID_DataProv, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
