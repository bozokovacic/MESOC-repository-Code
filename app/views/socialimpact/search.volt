    ...
    <thead>
        <tr>
           <th>CROSS-OVER THEME</th>
            <th>CROSS-OVER THEME DECRIPTION</th>
         </tr>
    </thead>
{% endif %}
    <tbody>
        <tr>
         <td>{{ socialimpact.SocImpactName }}</td>
            ...
            <td with="7%">{{ link_to("socialimpact/edit/" ~ socialimpact.ID_SocImpact, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("socialimpact/delete/" ~ socialimpact.ID_SocImpact, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
