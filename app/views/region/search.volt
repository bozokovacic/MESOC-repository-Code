...
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("region/edit/" ~ region.ID_Region, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("region/delete/" ~ region.ID_Region, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
