...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/institutiondelete/" ~ docinstitution.ID_Institution, '<i class="glyphicon glyphicon-remove"></i> Delete institution', "class": "btn btn-default") }}</td>
