    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ document.Links }}</td>
             ...
             {{ link_to("documentresearch/linkscountry/" ~ document.ID_Doc, 'Country', "class": "btn btn-primary") }}   
...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/relevancedelete/" ~ docrelevance.ID_Relevance, '<i class="glyphicon glyphicon-remove"></i> Delete relevance', "class": "btn btn-default") }}</td>
