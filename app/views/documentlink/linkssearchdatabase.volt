...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/searchdatabasedelete/" ~ docsearchdatabase.ID_Database, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
...
{{ form("documentlink/searchdatabasesearch/" ~ document.ID_Doc) }}

<h3>ADD SEARCH DATABASE TO DOCUMENT</h3>
