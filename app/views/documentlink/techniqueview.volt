...
<!--        {{ link_to("documentlink/linksrelevance/" ~ document.ID_Doc, 'Relevance', "class": "btn btn-primary") }} 
            {{ link_to("documentlink/linksbeneficiary/" ~ document.ID_Doc, 'Beneficiary', "class": "btn btn-primary") }}   --> <h3>TECHNIQUE</h3> 
...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/techniquedelete/" ~ doctechnique.ID_Technique, '<i class="glyphicon glyphicon-remove"></i> Delete technique', "class": "btn btn-default") }}</td>
