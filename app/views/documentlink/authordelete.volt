...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/deleteauthor/" ~ docauthor.ID_Author, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
...
{{ form("documentlink/searchauthor/" ~ document.ID_Doc) }}
