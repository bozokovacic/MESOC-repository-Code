...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/searchdatabasedelete/" ~ docsearchdatabase.ID_Database, 'Delete search database', "class": "btn btn-default") }}</td>
