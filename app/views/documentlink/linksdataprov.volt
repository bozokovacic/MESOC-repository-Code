...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        <tr>
        <td>{{ docdataprov.getDataProv().DataProvName }}</td>
        <td with="7%">{{ link_to("documentlink/dataprovdelete/" ~ docdataprov.ID_DataProv, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
...
{{ form("documentlink/dataprovsearch/" ~ document.ID_Doc) }}

<h3>ADD DATA PROVIDER TO DOCUMENT</h3>
