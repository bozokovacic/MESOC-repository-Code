...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/cityadd/" ~ city.ID_City, ' Add to document', "class": "btn btn-default") }}</td>
      ...
      <tbody>
        <tr>
            <td colspan="11" align="right">
                <div class="btn-group">
                    {{ link_to("documentlink/citysearch/institution/search", '<i class="icon-fast-backward"></i> First', "class": "btn") }}
                    {{ link_to("documentlink/citysearch/search?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn") }}
                    {{ link_to("documentlink/citysearch/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn") }}
                    {{ link_to("documentlink/citysearch/search?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn") }}
