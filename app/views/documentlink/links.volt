    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ document.Links }}</td>
             ...
             {{ link_to("document/author/adddoc" ~ document.ID_Doc, 'Author', "class": "btn btn-primary") }} {{ link_to("document/author/adddoc" ~ document.ID_Doc, 'Country', "class": "btn btn-primary") }}   
             {{ link_to("document/author/adddoc" ~ document.ID_Doc, 'Search database', "class": "btn btn-primary") }} 
             {{ link_to("document/author/adddoc" ~ document.ID_Doc, 'Technique', "class": "btn btn-primary") }} 
             {{ link_to("document/author/adddoc" ~ document.ID_Doc, 'Relevance', "class": "btn btn-primary") }} 
...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("document/techniquedelete/" ~ doctechnique.ID_Technique, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
