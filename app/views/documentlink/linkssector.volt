...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/sectordelete/" ~ docsector.ID_Sector, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
  ...
  {% endif %}
{% else %}
    No sector are recorded.
{% endfor %} 

{{ form("documentlink/sectorsearch/" ~ document.ID_Doc) }}

<h3>ADD SECTOR TO DOCUMENT</h3>
