...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        ...
        <td with="7%">{{ link_to("documentlink/dataprovdelete/" ~ docdataprov.ID_DataProv, '<i class="glyphicon glyphicon-remove"></i> Delete data provider', "class": "btn btn-default") }}</td>
