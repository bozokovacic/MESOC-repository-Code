...
<!--            <td>{{ doccountry.ID_Research }}</td>     --> 
            ...
            <td with="7%">
                {% switch doccountry.ID_Country %}
                    {% case  1  %}
                      {{ link_to("documentresearch/countryadd/" ~ doccountry.ID_Research,'<i class="glyphicon glyphicon-remove"></i> Define Country', "class": "btn btn-default") }}
                    {% break %}
                    {% default %}
                        {{ link_to("documentresearch/countrydelete/" ~ doccountry.ID_Research,'<i class="glyphicon glyphicon-remove"></i>Delete Country', "class": "btn btn-default") }}        
                {% endswitch %} 
                {% switch doccountry.ID_Region %}
                    {% case  1  %}
                        {{ link_to("documentresearch/countryselectRegion/" ~ doccountry.ID_Research,'<i class="glyphicon glyphicon-edit"></i> Define Region', "class": "btn btn-default") }}    
                    {% break %}
                    {% default %}
                ...
                {% switch doccountry.ID_City %}
                    {% case  1  %}
                        {{ link_to("documentresearch/countryselectCity/" ~ doccountry.ID_Research,'<i class="glyphicon glyphicon-edit"></i> Define City', "class": "btn btn-default") }}    
                    {% break %}
                    {% default %}
