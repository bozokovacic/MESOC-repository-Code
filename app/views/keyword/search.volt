...
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("keyword/edit/" ~ keyword.ID_Keyword, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("keyword/delete/" ~ keyword.ID_Keyword, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
