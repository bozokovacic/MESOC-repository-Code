...
{{ link_to("analyse/statisticyeardomain/" ~ "0", ' ALL DOCUMENTS', "class": "btn btn-default") }}  
{{ link_to("analyse/statisticyeardomain/" ~ "2", ' SCIENTIFIC DOCUMENTS', "class": "btn btn-default") }}  
{{ link_to("analyse/statisticyeardomain/" ~ "3", ' GREY LITERATURE', "class": "btn btn-default") }}   
{{ link_to("analyse/statisticyeardomain/" ~ "1", ' UNDEFINED', "class": "btn btn-default") }}
