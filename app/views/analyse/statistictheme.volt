...
{{ link_to("analyse/statistictheme/" ~ "0", ' ALL DOCUMENTS', "class": "btn btn-default") }} 
{{ link_to("analyse/statistictheme/" ~ "2", ' SCIENTIFIC DOCUMENTS', "class": "btn btn-default") }}  
{{ link_to("analyse/statistictheme/" ~ "3", ' GREY LITERATURE', "class": "btn btn-default")  }}   
{{ link_to("analyse/statistictheme/" ~ "1", ' UNDEFINED', "class": "btn btn-default") }}
