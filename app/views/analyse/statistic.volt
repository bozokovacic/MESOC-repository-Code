...
{{ link_to("analyse/statistic/" ~ "0", ' ALL DOCUMENTS', "class": "btn btn-default") }}  
{{ link_to("analyse/statistic/" ~ "2", ' SCIENTIFIC DOCUMENTS', "class": "btn btn-default") }}  
{{ link_to("analyse/statistic/" ~ "3", ' GREY LITERATURE', "class": "btn btn-default") }}   
{{ link_to("analyse/statistic/" ~ "1", ' UNDEFINED', "class": "btn btn-default") }}
<BR> <BR> 
