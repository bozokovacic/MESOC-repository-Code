...
<ul class="pager">
    ...
    <li class="pull-right">
        {{ link_to("analyse/new", "Create analyse") }}
    </li>
</ul>
...
<table class="table table-bordered table-striped" align="center">
    <thead>
        <tr>
            <th>ANALYSIS ID</th>
            <th>ANALYSIS NAME CODE</th>
            <th>ANALYSIS DESRIPTION</th>
         </tr>
    </thead>
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("analyse/edit/" ~ analyse.ID_Analyse, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("analyse/delete/" ~ analyse.ID_Analyse, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
