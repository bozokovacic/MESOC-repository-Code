...
{% endif %}
    <tbody>
        <tr>
            ...
            <td with="7%">{{ link_to("partner/edit/" ~ partner.ID_Partner, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td with="7%">{{ link_to("partner/delete/" ~ partner.ID_Partner, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
