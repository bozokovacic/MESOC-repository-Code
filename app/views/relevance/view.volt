    ...
    <tbody>
        <tr>
            ...
            <td>{{ relevance.Relevance }}</td>
                <td width="7%">{{ link_to("relevance/edit/" ~ relevance.ID_Relevance, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td width="7%">{{ link_to("relevance/delete/" ~ relevance.ID_Relevance, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
          <tr>
            <td colspan="11" align="right">
                <div class="btn-group">
                    ...
                    {{ link_to("relevance/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn") }}
