...
class SocialimpactController extends ControllerBase
{
    ...
    public function searchAction()
    {
        ...
        if (count($socialimpact) == 0) {
            $this->flash->notice("Cross-over theme is not found.");
    ...
    public function editAction($ID_SocImpact)
    {
        ...
        if (!$this->request->isPost()) {
            ...
            if (!$socialimpact) {
                $this->flash->error("Cross-over theme not found.");
                return $this->dispatcher->forward(
                    [
                        "controller" => "socialimpact",
                        "action"     => "index",
     ...
     public function createAction()
    {
        ...
        $this->flash->success("Cross-over theme successfully created.");
    ...
    public function saveAction()
    {
        ...
        $socialimpact = Socialimpact::findFirst("ID_SocImpact = '$ID_SocImpact'");
        if (!$socialimpact) {
            $this->flash->error("Cross-over theme does not exist.");
        ...
        $this->flash->success("Cross-over theme successfully updated.");
...
/**        $this->view->disable();
        ...
        $this->flash->success("Cross-over theme deleted");
